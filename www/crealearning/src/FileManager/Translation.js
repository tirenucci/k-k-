const translations = {
    ...
    fr: {
        uploading: 'Mis en ligne en cours',
        uploadingItem: 'Mis en ligne en cours d\'un fichier',
        uploadingItems: 'Mis en ligne en cours de {quantity} fichiers',
        upload: 'Mis en ligne',
        remove: 'Suppression',
        ...
        create: 'Créer',
        createFolder: 'Création d\'un dossier',
        zipping: 'Archivage',
...
export default function getMessage(locale, key, params) {
    ...
    const translation = translationExists ? translations[locale][key] : translations['fr'][key];
    if (!params) {
        return translation;
    }
